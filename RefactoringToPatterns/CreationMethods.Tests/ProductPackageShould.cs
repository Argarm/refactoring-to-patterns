...
namespace RefactoringToPatterns.CreationMethods.Tests
{
    public class ProductPackageShould
    {
        ...
        {
            var productPackage = ProductPackage.CreateSimplePackage("100MB");
        ...
        {
            var productPackage = ProductPackage.CreateInternetAndVoipPackage(91233788, "100MB");
        ...
        {
            var productPackage = ProductPackage.CreateFullPackage("100MB", 91233788, new[] {"LaLiga", "Estrenos"});
